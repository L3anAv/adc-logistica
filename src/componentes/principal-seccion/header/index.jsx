...
import {Svg} from '/src/componentes/styled-components-general/svg'
...
const header = () => {
  ...
  return (
   <>
      ...
      <ContenedorPrincipal ContactoTop={contactoFixed == true ? '10px' : '0'}
                           ContactoMarginTop={contactoFixed == true ? '0.3%' : '20px'}
                           ContactoPosition={contactoFixed == true ? 'fixed' : 'none'}
      >
      
      {contactoFixed == false ? <Titulo TituloVisibility={'visible'}>ADC ARGENTINA UNIENDO EMPRESAS</Titulo> 
                              : <Titulo TituloVisibility={'hidden'}>ADC ARGENTINA UNIENDO EMPRESAS</Titulo>}

      <ContenedorContacto >
      <IconoContacto IconoColor={contactoColor == true ? 'black' : 'white'}
      ...
      href='https://wa.me/5491171300447'>1171300447</TextoContacto>
      </ContenedorContacto>
      ...
      <TextoContacto TextoColor={contactoColor == true ? '#000' : '#fff'}
      href='https://wa.me/5491157494344'>1157494344</TextoContacto>
      </ContenedorContacto>
